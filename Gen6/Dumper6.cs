...
public static class Dumper6
{
    public static void DumpGen6()
    {
        ...
        static EncounterArea6[] GetEncounterTables(string ident, byte[] mini)
        {
            ...
            return EncounterArea6.GetArray(data);
        }

        MarkG6XYSlots(ref XSlots);
        MarkG6XYSlots(ref YSlots);
        XSlots = [..XSlots, ..SlotsXYAlt];
        YSlots = [..YSlots, ..SlotsXYAlt];
    ...
    private static void MarkG6XYSlots(ref EncounterArea6[] Areas)
    {
        ...
        foreach (var area in Areas)
        {
            ...
            var hordeA = new EncounterArea6 { Location = area.Location, Type = Horde, Slots = horde };
            extra.Add(hordeA);
    ...
    private static void MarkG6AOSlots(ref EncounterArea6[] Areas)
    {
        ...
        foreach (var area in Areas)
        {
            ...
            var rockA = new EncounterArea6 { Location = area.Location, Type = Rock_Smash, Slots = rock };
            extra.Add(rockA);
    ...
    [
        new EncounterArea6 { Location = 104, // Victory Road
            Type = Grass,
            Slots =
            [
                // Drops
        ...
        new EncounterArea6 { Location = 34, // Route 6
            Type = Grass,
            Slots =
            [
                // Rustling Bush
