...
public sealed record Crossover7b(ushort Species, byte LevelMin, byte LevelMax, byte FromArea, byte ToArea)
{
    public static readonly List<Crossover7b> AllCrossovers =
    [
